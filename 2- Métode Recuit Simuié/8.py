#Donne un positionnement, determine voisin et minimum
...
def voisinage(tab):
    ...
    #     msg2 = min(confvois) 
    print(vois[m.index(min(m))], min(confvois))
    #return print('=====>On aura pour positionnement min : ',msg1, ' dont le conflit est de :', msg2)  
